package com.wuledi.interfaces.model.entity;
...
public class UserInterfaceInfoDO {
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        UserInterfaceInfoDO other = (UserInterfaceInfoDO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getUsedNumber() == null ? other.getUsedNumber() == null : this.getUsedNumber().equals(other.getUsedNumber()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getUsedNumber() == null) ? 0 : getUsedNumber().hashCode());
