...
(
    id              bigint auto_increment comment 'id' primary key not null comment '题目id',
    title           varchar(512)                                   null comment '标题',
    content         text                                           null comment '内容',
    tags            varchar(1024)                                  null comment '标签列表（json 数组）',
    answer          text                                           null comment '题目答案',
    submit_number   int      default 0                             not null comment '题目提交数',
    accepted_number int      default 0                             not null comment '题目通过数',
...
(
    id             bigint auto_increment comment 'id' primary key not null comment '题目提交id',
